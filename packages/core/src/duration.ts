...
/** The milliseconds a duration such as `"1.5h"` denotes, or NaN when the text is not a duration. */
...
/**
 * The milliseconds `duration` denotes. A number is returned as given and a string is parsed as a
 * duration such as `"24h"`. Returns NaN for anything else.
 */
